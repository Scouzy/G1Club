...
INSERT INTO "new_Message" ("categoryId", "content", "createdAt", "id", "receiverId", "senderId", "teamId") SELECT "categoryId", "content", "createdAt", "id", "receiverId", "senderId", "teamId" FROM "Message";
DROP TABLE "Message";
